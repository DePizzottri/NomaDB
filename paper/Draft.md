...
Двудольность графа проверяется поиском в глубину и попутным разбиением вершин на 2 класса. Если в процессе поиска вершину необходимо отнести сразу к двум классам граф считается недвудольным.

Запуски генерации показали, что практической необходимости в распараллеливании или какой либо оптимизации нет, т.к. онсновной объем времени занимает непосредственно перебор.
