...
# II. В поисках оптимальных логических часов. Рабочий отчет.
...
Для конфигураци с количеством процессов 5 и 6 возможно применить Ψ-композицию для различных mΨ, и для их перестановок, однако такой подход не является системным и потому кроме как для 4х процессов более не применялся.
